...
int main(int argc, char **argv) {
    ...
    private_nh.param<bool>(param_ns_prefix_ + "/is_object_builder_open",is_object_builder_open_, false);
    ...
    clusters_pub_ =
            nh.advertise<sensor_msgs::PointCloud2>(pub_pc_clusters_topic, 1);     //MODIFICADO (NO COMENTADO)
